...
button.addEventListener("click", function () {
    ...
    setTimeout(() => {
        ...
        window.location.href = "./love/love.html"; // Thay đổi đường dẫn nếu cần
    }, 200);
});

function progressInterva() {
    console.log(`Count: ${count}, PercentWidth: ${percentWidth}`);
    
    if (count === 100 && percentWidth === 100) {
        clearInterval(progressLoad);
        percent.textContent = "Xong goiiii nè";
        ...
        setTimeout(() => {
            textBtn.textContent = "E bấm đây i";
